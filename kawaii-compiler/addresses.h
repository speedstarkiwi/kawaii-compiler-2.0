...
#define r_print x2(ROBLOX_FUNC_CREATE(r_print_address,r_print_return,r_print_ccv, int a1, int txt))
...
#define r_deserializer x2(ROBLOX_FUNC_CREATE(r_deserializer_address,r_deserializer_return,r_deserializer_ccv, int rL, std::string c, int txt, int idk))
#define r_spawn_address x(RBX_ADDY_OBF_DEOBF(0x3D0ED0))
#define r_spawn_ccv __cdecl
#define r_spawn_return int
#define r_spawn x2(ROBLOX_FUNC_CREATE(r_spawn_address,r_spawn_return,r_spawn_ccv, int rL))
} addresses;
namespace lua {
struct offsets {
#define r_s_js 0x134
